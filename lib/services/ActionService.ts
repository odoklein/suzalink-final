...
const ACTION_RESULT_ALIASES: Record<string, ActionResult> = {
    ...
    NE_REPOND_PAS: "NO_RESPONSE",
    NE_REPOND_PLUS: "NO_RESPONSE",
    NE_DECROCHE_PAS: "NO_RESPONSE",
    NE_JOIGNABLE_PAS: "NO_RESPONSE",
    PAS_JOIGNABLE: "NO_RESPONSE",
    NRP: "NO_RESPONSE",
    PAS_DE_REPONSE: "NO_RESPONSE",
    AUCUNE_REPONSE: "NO_RESPONSE",
    MAUVAIS_CONTACT: "BAD_CONTACT",
    BARRAGE: "BARRAGE_STANDARD",
    NUMERO_INVALIDE: "NUMERO_KO",
    NUMERO_HS: "NUMERO_KO",
    PAS_INTERESSE: "NOT_INTERESTED",
    NON_INTERESSE: "NOT_INTERESTED",
    REFUS_ARGUMENTE: "REFUS_ARGU",
    REFUS_ARG: "REFUS_ARGU",
    REFUS_TOTAL: "REFUS_CATEGORIQUE",
    REFUS_DEFINITIF: "REFUS_CATEGORIQUE",
    RAPPEL_A_PREVOIR: "RELANCE",
    RAPPEL_PROGRAMME: "RAPPEL",
    GERE_SIEGE: "GERE_PAR_SIEGE",
    GERE_PAR_LE_SIEGE: "GERE_PAR_SIEGE",
    FAUX_NUM: "FAUX_NUMERO",
    MAUVAIS_INTERLOCUTEUR_CONTACT: "MAUVAIS_INTERLOCUTEUR",
    MAIL_ONLY: "MAIL_UNIQUEMENT",
    MAIL_SEULEMENT: "MAIL_UNIQUEMENT",
    BARRAGE_SECRETAIRE_STANDARD: "BARRAGE_SECRETAIRE",
    ENVOI_DOC: "MAIL_DOC",
    ENVOI_DOCUMENTATION: "MAIL_DOC",
    HORS_CIBLE_CLIENT: "HORS_CIBLE",
    DEJA_FORMULAIRE: "MEETING_BOOKED_FORM",
    RAPEL: "RAPPEL",
